    ...
    <div class="form-container horarios-container">
        ...
        <div class="quick-actions-bar">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <button type="button" class="quick-btn" onclick="aplicarHorarioSemana('08:00', '17:00')">
                    <i class="bi bi-briefcase me-1"></i> Lun-Vie (08:00 - 17:00)
                </button>
                <button type="button" class="quick-btn" onclick="copiarLunesAResto()">
                    <i class="bi bi-files me-1"></i> Copiar Lunes a Vie
                </button>
                <button type="button" class="quick-btn" onclick="marcarTodos24h()">
                    <i class="bi bi-clock me-1"></i> Todos 24 Horas
                </button>
                <button type="button" class="quick-btn" onclick="marcarTodosCerrados()">
                    <i class="bi bi-x-circle me-1"></i> Todos Cerrados
                </button>
            </div>
        </div>

        <form id="form-horarios" class="form-card" action="{{ route('horario.store') }}" method="POST">
            @csrf
