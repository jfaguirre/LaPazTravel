    ...
    <div class="form-container precios-container">
        ...
        <div class="quick-actions-bar">
            ...
            <div class="d-flex gap-2 flex-wrap">
                <button type="button" class="quick-btn" onclick="cargarPlantillaEstandar()">
                    <i class="bi bi-person-badge me-1"></i> Entrada General / Niños / Tercera Edad
                </button>
                <button type="button" class="quick-btn" onclick="cargarPlantillaGratis()">
                    <i class="bi bi-ticket-perforated me-1"></i> Entrada Gratuita ($0.00)
                </button>
                <button type="button" class="quick-btn" onclick="vaciarPrecios()">
                    <i class="bi bi-trash me-1"></i> Limpiar Todo
                </button>
            </div>
        </div>

        <form id="form-precios" class="form-card" action="{{ route('precio.store') }}" method="POST">
            @csrf
            ...
            <button type="button" class="btn-agregar-fila mb-4" onclick="agregarFilaPrecio()">
        ...
        tr.innerHTML = `
            <td>
                ...
                <input type="text" name="precios[${index}][categoria]" value="${categoria}" 
                    ...
                    required oninput="actualizarPreviewPrecios()">
            </td>
            <td>
                <div class="input-group input-group-sm d-flex flex-row">                   
                    <input type="number" step="0.01" min="0" name="precios[${index}][precioEntrada]" value="${precioEntrada !== '' ? precioEntrada : ''}" 
                        placeholder="0.00" class="input-precio-monto" required oninput="actualizarPreviewPrecios()">
                </div>
            </td>
            <td>
                <input type="text" name="precios[${index}][descripcion]" value="${descripcion}" 
                    ...
                    maxlength="100" oninput="actualizarPreviewPrecios()">
            </td>
            <td style="text-align: center;">
                <button type="button" class="btn-eliminar-fila" onclick="eliminarFilaPrecio(${index})" title="Eliminar tarifa">
